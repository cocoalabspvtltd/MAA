...
//
    ...
    NSLog(@"Search Mutable Dictionary:%@",searchMutableDictionary);
    [[NetworkHandler sharedHandler] requestWithRequestUrl:[NSURL URLWithString:doctorr] withBody:searchMutableDictionary withMethodType:HTTPMethodPOST withAccessToken:_token];
    [[NetworkHandler sharedHandler] startServieRequestWithSucessBlockSuccessBlock:^(id responseObject) {
        [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
        doctorsArray = [responseObject valueForKey:@"data"];
