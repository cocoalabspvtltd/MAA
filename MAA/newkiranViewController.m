//
//  newkiranViewController.m
//  maa.stroyboard
//
//  Created by Cocoalabs India on 17/03/16.
//  Copyright © 2016 Cocoalabs India. All rights reserved.
//

#import "newkiranViewController.h"

@interface newkiranViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>
{
    NSArray *coll1;
    NSArray *coll2;
}
...
@implementation newkiranViewController
...
{
    if (collectionView == _collview1) {
        return coll1.count;
    }
    if (collectionView == _collview2) {
        return coll2.count;
    }
    return 1;
}
