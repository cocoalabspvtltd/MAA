...
@interface DoctorThirdTabTVC : UITableViewCell
@property (strong, nonatomic) IBOutlet UILabel *reviewrNameLabel;

@property (strong, nonatomic) IBOutlet UILabel *reviewContentLabel;
